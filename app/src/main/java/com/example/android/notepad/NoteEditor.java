        ...
        switch (item.getItemId()) {
            ...
            case R.id.changeback:
                ...
                button_DarkGray.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        View note_edit = (View)findViewById(R.id.note);
                        note_edit.setBackgroundColor(Color.parseColor("#A9A9A9"));
                        aDialog.dismiss();
                    }
                });
                /*变为黄色背景*/
                ...
                button_Honeydew.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        View note_edit = (View)findViewById(R.id.note);
                        note_edit.setBackgroundColor(Color.parseColor("#F0FFF0"));
                        aDialog.dismiss();
                    }
                });
                /*变为黄色背景*/
                ...
                button_lavender.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        View note_edit = (View)findViewById(R.id.note);
                        note_edit.setBackgroundColor(Color.parseColor("#E6E6FA"));
                        aDialog.dismiss();
                    }
                });
                ...
                button_deepskyblue.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        View note_edit = (View)findViewById(R.id.note);
                        note_edit.setBackgroundColor(Color.parseColor("#00BFFF"));
                        aDialog.dismiss();
                    }
                });
                ...
                button_PaleVioletRed.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        View note_edit = (View)findViewById(R.id.note);
                        note_edit.setBackgroundColor(Color.parseColor("#DB7093"));
                        aDialog.dismiss();
                    }
                });
                break;
