    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.changeback:
                ...
                /*变为黄色背景*/
                Button button_DarkGray = (Button) layout.findViewById(R.id.DarkGray);
                button_DarkGray.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        RelativeLayout note_list = (RelativeLayout)findViewById(R.id.noteLayout);
                        note_list.setBackgroundColor(Color.parseColor("#A9A9A9"));
                        aDialog.dismiss();
                    }
                });
                /*变为黄色背景*/
                Button button_Honeydew = (Button) layout.findViewById(R.id.Honeydew);
                button_Honeydew.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        RelativeLayout note_list = (RelativeLayout)findViewById(R.id.noteLayout);
                        note_list.setBackgroundColor(Color.parseColor("#F0FFF0"));
                        aDialog.dismiss();
                    }
                });
                /*变为黄色背景*/
                ...
                Button button_lavender = (Button) layout.findViewById(R.id.lavender);
                button_lavender.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        RelativeLayout note_list = (RelativeLayout)findViewById(R.id.noteLayout);
                        note_list.setBackgroundColor(Color.parseColor("#E6E6FA"));
                        aDialog.dismiss();
                    }
                });
                Button button_deepskyblue = (Button) layout.findViewById(R.id.deepskyblue);
                button_deepskyblue.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        RelativeLayout note_list = (RelativeLayout)findViewById(R.id.noteLayout);
                        note_list.setBackgroundColor(Color.parseColor("#00BFFF"));
                        aDialog.dismiss();
                    }
                });
                Button button_PaleVioletRed = (Button) layout.findViewById(R.id.PaleVioletRed);
                button_PaleVioletRed.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        RelativeLayout note_list = (RelativeLayout)findViewById(R.id.noteLayout);
                        note_list.setBackgroundColor(Color.parseColor("#DB7093"));
                        aDialog.dismiss();
                    }
                });
